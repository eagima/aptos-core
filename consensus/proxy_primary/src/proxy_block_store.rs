...
impl ProxyBlockStore {
    ...
    /// Create a new proxy block store for an epoch start.
    ///
    /// This creates genesis QCs for proxy consensus at the start of an epoch.
    ...
    pub fn new_for_epoch(epoch: u64) -> Self {
        ...
        // Create a genesis block info for this epoch
        ...
        Self::new(genesis_block_id, genesis_qc.clone(), genesis_qc)
    }
